...
/**
 * Weighted Union Find implementation using Integer, Double for size and array (as in the book)
 * <p>
 * This was made to display that the UnionFind interface supports multiple types and not for working with in practice.
 */
public class WeightedUFDouble implements UnionFind<Integer> {
    private final Integer[] id; // parent link
    private Double[] size; // size of component for roots
